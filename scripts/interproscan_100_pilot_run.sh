...
# run as:
# sbatch \
#   --job-name=ips_test100 \
#   --export=ALL,IPS=/uoa/scratch/users/r02hw22/software/interproscan/interproscan-5.77-108.0/interproscan.sh,QUERY=02_annotation/interproscan/test_input/equina_test100.aa.fa,RUN_NAME=equina_test100 \

#!/bin/bash
#SBATCH --job-name=diamond_rep_test100
#SBATCH --mem=128G
...
run_diamond_search () {
    ...
    # Column 11 is evalue in the selected DIAMOND outfmt:
...
run_diamond_search \
    ...
    "02_annotation/diamond/raw/equina_test100_vs_swissprot_all_representative.diamond.tsv" \
    "02_annotation/diamond/filtered/equina_test100_vs_swissprot_all_representative.evalue_1e-5.diamond.tsv" \
    "02_annotation/diamond/filtered/equina_test100_vs_swissprot_all_representative.evalue_1e-5.top_hits.tsv"

run_diamond_search \
    "TrEMBL" \
    "$TREMBL_FASTA" \
    "02_annotation/db/trembl_cnidaria_selected" \
    "02_annotation/diamond/raw/equina_test100_vs_trembl_cnidaria_selected_representative.diamond.tsv" \
    "02_annotation/diamond/filtered/equina_test100_vs_trembl_cnidaria_selected_representative.evalue_1e-5.diamond.tsv" \
    "02_annotation/diamond/filtered/equina_test100_vs_trembl_cnidaria_selected_representative.evalue_1e-5.top_hits.tsv"

echo "All DIAMOND test100 searches completed successfully."
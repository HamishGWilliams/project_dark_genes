#!/bin/bash
#SBATCH --job-name=diamond_uniprot
#SBATCH --mem=128G
...
run_diamond_search \
    ...
    "02_annotation/diamond/equina_vs_swissprot_all.diamond.tsv" \
    "02_annotation/diamond/equina_vs_swissprot_all.top_hits.tsv"

run_diamond_search \
    "TrEMBL" \
    "$TREMBL_FASTA" \
    "02_annotation/db/trembl_cnidaria_selected" \
    "02_annotation/diamond/equina_vs_trembl_cnidaria_selected.diamond.tsv" \
    "02_annotation/diamond/equina_vs_trembl_cnidaria_selected.top_hits.tsv"
